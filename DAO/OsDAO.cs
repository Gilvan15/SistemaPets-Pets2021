            ...
            using (SqlConnection con = new SqlConnection())
            {
                try
                {
                    ...
                    cn.CommandText = "INSERT INTO Oservico ([nomepet], [especie], [raca], " +
                        ...
                        "[checkserv3], [valorserv3], [servico4], [valorserv4], [taxaentrega], [hora], [data], [dataos], [valortotal], [desconto], [valorfinal], [formapgto1], [valor1], [checkpgto2], [formapgto2], [valor2], [checkpgto3], [formapgto3], [valor3])" +
                        ...
                        "@servico3, @checkserv3, @valorserv3, @servico4, @valorserv4, @taxaentrega, @hora, @data, @dataos, @valortotal, @desconto, @valorfinal, @formapgto1, @valor1, @checkpgto2, @formapgto2, @valor2, @checkpgto3, @formapgto3, @valor3)";
                    ...
                    cn.Parameters.Add("formapgto1", SqlDbType.VarChar).Value = objTabela.Formapgto1;
                    cn.Parameters.Add("valor1", SqlDbType.VarChar).Value = objTabela.Valor1;

                    cn.Parameters.Add("checkpgto2", SqlDbType.VarChar).Value = objTabela.Checkpgto2;
                    cn.Parameters.Add("formapgto2", SqlDbType.VarChar).Value = objTabela.Formapgto2;
                    cn.Parameters.Add("valor2", SqlDbType.VarChar).Value = objTabela.Valor2;

                    cn.Parameters.Add("checkpgto3", SqlDbType.VarChar).Value = objTabela.Checkpgto3;
                    cn.Parameters.Add("formapgto3", SqlDbType.VarChar).Value = objTabela.Formapgto3;
                    cn.Parameters.Add("valor3", SqlDbType.VarChar).Value = objTabela.Valor3;
            ...
            using (SqlConnection con = new SqlConnection())
            {
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        ...
                        dado.Formapgto1 = Convert.ToString(dr["formapgto1"]);
                        dado.Valor1 = Convert.ToString(dr["valor1"]);

                        dado.Checkpgto2 = Convert.ToString(dr["checkpgto2"]);
                        dado.Formapgto2 = Convert.ToString(dr["formapgto2"]);
                        dado.Valor2 = Convert.ToString(dr["valor2"]);

                        dado.Checkpgto3 = Convert.ToString(dr["checkpgto3"]);
                        dado.Formapgto3 = Convert.ToString(dr["formapgto3"]);
                        dado.Valor3 = Convert.ToString(dr["valor3"]);
            ...
            using (SqlConnection con = new SqlConnection())
            {
                ...
                cn.CommandText = "UPDATE Oservico SET  nomepet = @nomepet, especie = @especie, raca = @raca, " +
                    "proprietario = @proprietario, telefone = @telefone, email = @email, c_especiais = @c_especiais, alergico = @alergico," +
                        ...
                        "servico3 = @servico3, checkserv3 = @checkserv3, valorserv3 = @valorserv3, " +
                        "servico4 = @servico4, valorserv4 = @valorserv4, taxaentrega = @taxaentrega, " +
                        "hora = @hora, " /*data = @data, dataos = @dataos,*/ + " valortotal = @valortotal, " +
                        "desconto = @desconto, valorfinal = @valorfinal,  formapgto1 = @formapgto1, valor1 = @valor1," +
                        "checkpgto2 = @checkpgto2, formapgto2 = @formapgto2, valor2 = @valor2, checkpgto3 = @checkpgto3, formapgto3 = @formapgto3, valor3 = @valor3 " + "WHERE id = @id";
