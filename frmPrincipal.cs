...
namespace SistemaPet
{
    public partial class frmPrincipal : Form
    {
        ...
        private void soundLembrete()
        {
            SoundPlayer player = new SoundPlayer(pasta_aplicacao + "wavs\\lembrete.wav");
            player.Play();
        }
        ...
        */
        ...
        private void bunifuMenuBackup_Click(object sender, EventArgs e)
        {

            AbrirFormWrapper(new FormBackup());
