...
namespace SistemaPet.subForms
{
    public partial class frmOS : Form
    {
        ...
        public frmOS(string vtextCod, string vcombonomepet, string vtextEspecie, string vtextraca,
            ...
            string comboservico4, string vtextvalor4, string vcbTipoEntrega,  string vtexttaxaentrega, string vmasckhora,  string vvalortotal, string vdesconto,
            string vvalorfinal, string vformapgto1, string vvalor1, Boolean checkpgto2, string vformapgto2, string vvalor2, Boolean checkpgto3, string vformapgto3, string vvalor3)
        {
            InitializeComponent();
            ...
            comboBox1.Text = vformapgto1;
            textBoxValor1.Text = vvalor1;

            checkBox1.Checked = checkpgto2;
            comboBox2.Text = vformapgto2;
            textBoxValor2.Text = vvalor2;

            checkBox2.Checked = checkpgto3;
            comboBox3.Text = vformapgto3;
            textBoxValor3.Text = vvalor3;
        ...
        private void LimparCampos()
        {
            ...
            foreach (Control ctrl3 in groupBox3.Controls)
            {
                if (ctrl3 is TextBox)
                {
                ...
                if (ctrl3 is ComboBox)
                {
                    ((ComboBox)ctrl3).Text = string.Empty;
                }

                if (ctrl3 is CheckBox)
                {

                    ((CheckBox)ctrl3).Checked = false;
                }
        ...
        private void LimparCamposCheck2()
        {
            if (checkBox1.Checked == false)
            {
                comboBox2.Text = string.Empty;
                textBoxValor2.Text = string.Empty;
            ...
            if (checkBox2.Checked == false)
            {
                ...
                textBoxValor3.Text = string.Empty;
                checkBox2.Checked = false;
            }
                ...
                case "Salvar":
                    try
                    {
                        ...
                        if (result1 == DialogResult.Yes)
                        {
                            ...
                            objTabela.Formapgto1 = comboBox1.Text;
                            objTabela.Valor1 = textBoxValor1.Text;

                            if (checkBox1.Checked == true) { objTabela.Checkpgto2 = "1"; } else { objTabela.Checkpgto2 = "0"; }
                            objTabela.Formapgto2 = comboBox2.Text;
                            objTabela.Valor2 = textBoxValor2.Text;

                            if (checkBox2.Checked == true) { objTabela.Checkpgto3 = "1"; } else { objTabela.Checkpgto3 = "0"; }
                            objTabela.Formapgto3 = comboBox3.Text;
                            objTabela.Valor3 = textBoxValor3.Text;
        ...
        private void btnPrepararImpressao_Click(object sender, EventArgs e)
        {
            ...
            verify = 0;
            //sound1();
            if (Application.OpenForms.OfType<frmOS>().Count() > 100)
            {
                MessageBox.Show("Reinicie o Sistema Pets&Pets para esvaziar o Cache de memória!");
                //string colecao = Application.OpenForms.ToString();
                //MessageBox.Show(colecao);
            }
            else
            {
                ...
                Form frmrec = new frmOS(textCod.Text, comboNomePet.Text, textEspecie.Text, 
                    ...
                    comboServico4.Text, textValor4.Text, cbTipoEntrega.Text, textTaxaEntrega.Text, maskHora.Text, 
                    textTotal.Text, textDesconto.Text, textValorFinal.Text, comboBox1.Text, textBoxValor1.Text, checkBox1.Checked, comboBox2.Text, textBoxValor2.Text, checkBox2.Checked, comboBox3.Text, textBoxValor3.Text);
        ...
        private void dataGridView1_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                comboBox1.Text = dataGridView1.CurrentRow.Cells[28].Value.ToString();
                textBoxValor1.Text = dataGridView1.CurrentRow.Cells[29].Value.ToString();
                
                if (dataGridView1.CurrentRow.Cells[30].Value.ToString() == "1") { checkBox1.Checked = true; } else { checkBox1.Checked = false; }
                comboBox2.Text = dataGridView1.CurrentRow.Cells[31].Value.ToString();
                textBoxValor2.Text = dataGridView1.CurrentRow.Cells[32].Value.ToString();
                if (dataGridView1.CurrentRow.Cells[33].Value.ToString() == "1") { checkBox2.Checked = true; } else { checkBox2.Checked = false; }
                comboBox3.Text = dataGridView1.CurrentRow.Cells[34].Value.ToString();
                textBoxValor3.Text = dataGridView1.CurrentRow.Cells[35].Value.ToString();
        ...
        {
            if (textBoxValor1.Text == string.Empty) { return; }
            try
            {
                Moeda(ref textBoxValor1);
                verifyValue();
            }
            catch (Exception ex)
            {
        ...
        private void textBoxValor2_TextChanged(object sender, EventArgs e)
        {
            if (textBoxValor2.Text == string.Empty) { return; }
            try
            {
                Moeda(ref textBoxValor2);
                verifyValue();
            }
            catch (Exception ex)
            {
        ...
        {
            if (textBoxValor3.Text == string.Empty) { return; }
            try
            {
                Moeda(ref textBoxValor3);
                verifyValue();
            }
            catch (Exception ex)
            {
